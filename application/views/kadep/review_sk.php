                    ...
                    <div class="row" style="margin-left: 5px; margin-right: 5px;">
                        ...
                        <div class="md-stepper-horizontal orange">
                            ...
                            <div class="md-step active">
                                <a href="#" data-target="#my_modal" data-toggle="modal" data-id="0">
                                    <div class="md-step-circle"><span>1</span></div>
                                    <div class="md-step-title">Departemen</div>
                                    <div class="md-step-bar-left"></div>
                                    <div class="md-step-bar-right"></div>
                            ...
                            <?php } else { ?>
                            <div class="md-step active">
                                <a href="#" data-target="#my_modal" data-toggle="modal" data-id="1">
                                    <div class="md-step-circle"><span>2</span></div>
                                    <div class="md-step-title">Kadep</div>
                                    <div class="md-step-bar-left"></div>
                                    <div class="md-step-bar-right"></div>
                            ...
                            <?php } else { ?>
                            <div class="md-step active">
                                <a href="#" data-target="#my_modal" data-toggle="modal" data-id="2">
                                    <div class="md-step-circle"><span>3</span></div>
                                    <div class="md-step-title">Verifikator</div>
                                    <div class="md-step-bar-left"></div>
                                    <div class="md-step-bar-right"></div>
                            ...
                            <?php } else { ?>
                            <div class="md-step active">
                                <a href="#" data-target="#my_modal" data-toggle="modal" data-id="3">
                                    <div class="md-step-circle"><span>4</span></div>
                                    <div class="md-step-title">Supervisor</div>
                                    <div class="md-step-bar-left"></div>
                                    <div class="md-step-bar-right"></div>
                            ...
                            <?php } else { ?>
                            <div class="md-step active">
                                <a href="#" data-target="#my_modal" data-toggle="modal" data-id="4">
                                    <div class="md-step-circle"><span>5</span></div>
                                    <div class="md-step-title">Manager</div>
                                    <div class="md-step-bar-left"></div>
                                    <div class="md-step-bar-right"></div>
                            ...
                            <?php } else { ?>
                            <div class="md-step active">
                                <a href="#" data-target="#my_modal" data-toggle="modal" data-id="5">
                                    <div class="md-step-circle"><span>6</span></div>
                                    <div class="md-step-title">Wadek 1</div>
                                    <div class="md-step-bar-left"></div>
                                    <div class="md-step-bar-right"></div>
                            ...
                            <?php } else { ?>
                            <div class="md-step active">
                                <a href="#" data-target="#my_modal" data-toggle="modal" data-id="6">
                                    <div class="md-step-circle"><span>7 </span></div>
                                    <div class="md-step-title">Wadek 2</div>
                                    <div class="md-step-bar-left"></div>
                                    <div class="md-step-bar-right"></div>
                            ...
                            <?php } else { ?>
                            <div class="md-step active">
                                <a href="#" data-target="#my_modal" data-toggle="modal" data-id="7">
                                    <div class="md-step-circle"><span>8 </span></div>
                                    <div class="md-step-title">Dekan</div>
                                    <div class="md-step-bar-left"></div>
                                    <div class="md-step-bar-right"></div>
