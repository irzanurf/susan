...
class Wadek2 extends CI_Controller {
    ...
    public function index(){
        redirect(base_url('wadek2/daftar_sk'));
    }
    ...
    public function header(){
        ...
        $head['one3'] = "wadek2/all";
        $head['two1'] = $this->M_SK->get_count_sk_diproses(array("status"=>6));
        $head['two2'] = "Harus Segera diproses";
        $head['three1'] = $this->M_SK->get_count_sk_disetujui(array("status >"=>6));
        $head['three2'] = "Total disetujui";
        $head['three3'] = "wadek2/total";
    ...
    public function review(){
        ...
        $data['url'] = "wadek2/insert_review";
        $data['val_stat'] = "6";
        $data['url_reject'] = "wadek2/reject";
    ...
    public function insert_review(){
        ...
        $this->M_SK->insert_wadek2_rev($data_review, $set);
        //log data
        $round = $this->M_SK->get_round_log(array('id_sk'=>"$id",'next_user'=>7))->row()->round;
        $log = [
             "id_sk"=>$id,
             "user"=>7,
             "round"=>$round,
