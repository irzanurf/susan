...
class Dekan extends CI_Controller {
    ...
    public function index(){
        redirect(base_url('dekan/daftar_sk'));
    }
    ...
    public function header(){
        ...
        $head['three1'] = $this->M_SK->get_count_sk_disetujui(array("status >"=>7));
        $head['three2'] = "Total disetujui";
        $head['three3'] = "dekan/total";
    ...
    public function review(){
        ...
        $this->header();
        $this->load->view('dekan/review_sk', $data);
        $this->load->view('layout/footer');
    }
    ...
    public function insert_review(){
        ...
        $this->M_SK->insert_dekan_rev($data_review, $set);
        //log data
        $round = $this->M_SK->get_round_log(array('id_sk'=>"$id",'next_user'=>8))->row()->round;
        $log = [
             "id_sk"=>$id,
             "user"=>8,
             "round"=>$round,
