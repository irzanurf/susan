...
class Manager extends CI_Controller {
    ...
    public function index(){
        redirect(base_url('manager/daftar_sk'));
    }
    ...
    public function header(){
        ...
        $head['one3'] = "manager/all";
        $head['two1'] = $this->M_SK->get_count_sk_diproses(array("status"=>4));
        $head['two2'] = "Harus Segera diproses";
        $head['three1'] = $this->M_SK->get_count_sk_disetujui(array("status >"=>4));
        $head['three2'] = "Total disetujui";
        $head['three3'] = "manager/total";
    ...
    public function review(){
        ...
        $data['url'] = "manager/insert_review";
        $data['val_stat'] = "4";
        $data['url_reject'] = "manager/reject";
        ...
        $this->header();
        $this->load->view('manager/review_sk', $data);
        $this->load->view('layout/footer');
    }
    ...
    public function insert_review(){
        ...
        //log data
        $round = $this->M_SK->get_round_log(array('id_sk'=>"$id",'next_user'=>5))->row()->round;
        $log = [
            "id_sk"=>$id,
            "user"=>5,
            "round"=>$round,
        ...
        $this->M_SK->update_sk($data_wd, $id);
        $this->M_SK->insert_manager_rev($data_review, $set);
