...
class Wadek1 extends CI_Controller {
    ...
    public function index(){
        redirect(base_url('wadek1/daftar_sk'));
    }
    ...
    public function header(){
        ...
        $head['one3'] = "wadek1/all";
        $head['two1'] = $this->M_SK->get_count_sk_diproses(array("status"=>5));
        $head['two2'] = "Harus Segera diproses";
        $head['three1'] = $this->M_SK->get_count_sk_disetujui(array("status >"=>5));
        $head['three2'] = "Total disetujui";
        $head['three3'] = "wadek1/total";
    ...
    public function insert_review(){
        ...
        $this->M_SK->insert_wadek1_rev($data_review, $set);
        //log data
        $round = $this->M_SK->get_round_log(array('id_sk'=>"$id",'next_user'=>6))->row()->round;
        $log = [
            "id_sk"=>$id,
            "user"=>6,
            "round"=>$round,
