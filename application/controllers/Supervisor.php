...
class Supervisor extends CI_Controller {
    ...
    public function header(){
        ...
        $head['one3'] = "supervisor/all";
        $head['two1'] = $this->M_SK->get_count_sk_diproses(array("status"=>2));
        $head['two2'] = "Harus Segera diproses";
        $head['three1'] = $this->M_SK->get_count_sk_disetujui(array("status >"=>2));
        $head['three2'] = "Total disetujui";
        $head['three3'] = "supervisor/total";
    ...
    public function review(){
        ...
        $data['url'] = "supervisor/insert_review";
        $data['url_reject'] = "supervisor/reject";
        $data['val_stat'] = "2";
        ...
        if (!empty($supervisor)){
            ...
            // $data['catatan']=$supervisor->catatan;
        };
    ...
    public function insert_review(){
        ...
        //log data
        $round = $this->M_SK->get_round_log(array('id_sk'=>"$id",'next_user'=>3))->row()->round;
        $log = [
            "id_sk"=>$id,
            "user"=>3,
            "round"=>$round,
        ...
        $this->M_SK->insert_spv_rev($data_review, $set);
